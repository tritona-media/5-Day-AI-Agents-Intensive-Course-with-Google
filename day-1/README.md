# [Original Code](./agent/agent_original.py)
## Agent
An agent is created by the `google.adk.agents.Agent` class. It needs a _name_, a _model_, an optional _description_, an optional _instruction_ and optional _tools_ list.
